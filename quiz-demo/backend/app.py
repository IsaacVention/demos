...
class QuizMachine(StateMachine):
    ...
    def __init__(
        ...
        countdown_publisher: Optional[Callable[[int], None]] = None,
        *args,
        **kwargs,
    ):
        ...
        self.countdown_publisher = countdown_publisher
    ...
    async def _countdown_task(self, timeout_seconds: int):
        ...
        for remaining in range(timeout_seconds, 0, -1):
            ...
            if self.countdown_publisher:
                self.spawn(self.countdown_publisher(remaining))
